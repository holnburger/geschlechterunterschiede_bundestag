...
\todo[inline]{NEU noch zu überarbeiten und optimale Stelle hierfür finden!!!!In einer Studie mit deutschen und belgischen Schulkindern konnte festgestellt werden, dass die grammatikalische Form der Berufsbezeichnungen die Wahrnehmung der Kinder von typisch männlichen Berufen beeinflusst: wenn Berufe im Männlichen dargestellt wurden (z.B, Ingenieure) wurden weiblichen Ingenieurinnen mental weniger angesprochen als wenn feminine und maskuline Wortpaare genutzt wurden (z.B. Ingenieurinnen und Ingenieure oder weibliche und männliche Ingenieure \parencites{vervecken_2013}{sczency_2016}). 
In another study, adult speakers as well envisaged more men in an occupation when job advertisements included more masculine than feminine forms ( !!!DAS HIER MUSS NOCH ÜBERSETZT WERDEN -  siehe \parencites {gaucheretal_2011}[3]{scency_2016}. 

In Anlenung an \textcite{sczency_2016} können verschiedene Strategien verwendet werden, um sprachliche Geschlechtergerechtigkeit zu erreichen und negative Auswirkungen von männlichen Generika zu vermeiden: \emph{Neutralisierung}, \emph{Feminisierung} und die \emph{Kombination der beiden}. Die geeignete Strategie ist hierbei abhängig von der betreffenden Sprache (grammatikalische Geschlechtssprache, natürliche Geschlechtssprache, oder geschlechtslose Sprache \parencites[vgl.][]{bußmann_2003}[][3]{scency_2016}.}

\todo[inline]{GINA NEU: HIER FÄNDE ICH DIE ÜBERSICHT VON SCZENCY AUF SEITE 3 OBEN als pdf eingefügt anschaulich - was denkst du?}
...
\begin{table}[htb]
    \centering
    \caption[Zufällige genderinklusive Ansprachen des entwickelten Diktionärs]{Zufällige genderinklusive Ansprachen des entwickelten Diktionärs}
