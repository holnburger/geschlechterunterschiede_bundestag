...
Die Auswertung mittels des Bonferroni-Dunn-Test (siehe Tab. \ref{table:dunn_test}) zeigt, dass sich die AfD und B90/Die Grünen nicht signifikant unterschieden (die AfD unterscheidet sich allerdings signifikant von allen anderen Parteien). Dies Ergebnis wurde nicht erwartet, da die 
