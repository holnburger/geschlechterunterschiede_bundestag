...
Wenngleich ein politischer Konsens darin besteht, dass Gleichheit - und impliziert Geschlechtergleichheit- eine fundamentale Komponente von Demokratie darstellt, gibt es noch immer einen Gender-Gap in weltweit jedem Parlament (NOCH MAL PRÜFEN - ob Ruanda). In der internationalen Diskussion gilt geschlechtergerechte Repräsentation im Parlament jedoch als signifikanter Indikator für die Modernität eines Staates  \parencite[vgl.][49]{holtkamp_2010} ZOTERO schon, aber noch HOCHLADEN
…
