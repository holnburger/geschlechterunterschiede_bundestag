...
\todo[inline]{Hier der Hintergrund dazu, wieso die AfD im Vergleich zu den anderen so häufig unterbricht. Erläuterung zur Methodik (auch wieder ein Kruskal-Wallis). Heteroskedastische Verteilung und keine Normalverteilung (QQ-Plots rein?).}

\begin{figure}
    \centering
    \includegraphics{document/images/boxp}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
