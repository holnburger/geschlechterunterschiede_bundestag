...
\todo[inline]{gewichtet würde ich rausnehmen - das machen wir nicht, da wir nicht eines schwerer wichten als das andere}

\begin{itemize}
    \item Ebene A: Weibliche Repräsentation im Parlament: Sind Frauen im Parlament vertreten? Wie viele Frauen sind relativ und absolut im Parlament vertreten? \todo[inline]{Wieso ist hier die Frage nach absolut und relativ gestellt? Das mach mMn hier keinen Sinn. Wenn eine Frau im Parlament vertreten ist, sind sie dann absolut vertreten? Wie kann man die Frage \enquote{Sind Frauen relativ im Paralament vertreten} beantworten? Relativ vertreten wären sie, wenn sie 50\% hätten, da die Geschlechterverteilung fast 50\% ist.}
    \item Ebene B: Weibliche Repräsentation bei den Parlamentsdebatten: Nehmen Frauen an den Parlamentsdebatten teil? Nehmen Frauen relativ und absolut gleich viel an den Parlamentsdebatten teil? \todo[inline]{Hab hier die Unterscheidung zwischen \enquote{absolut} und \enquote{relativ} nicht verstanden. Wenn Frauen nicht 50\% der Reden halten, haben sie dann absolut oder relativ weniger Reden? Vorschlag: \enquote{Entspricht der Redeanteil von Frauen deren Anteil an Sitzen im Parlament?}} 
    \item Ebene C: Repräsentation von Frauen in den Parlamentsdebatten: Werden in den Debatten Frauen ebenso wie Männer sprachlich repräsentiert? Wird Gender-Fair-Language (GFL) genutzt? Wird GFL von weiblichen und männlichen MPs in gleichem Maße genutzt? 
    ...
    \item Ebene E: Repräsentation von geschlechtsspezifischen Verhaltensmustern: Werden in den Parlamentsdebatten frauenfeindliche Verhaltensmuster reproduziert? Werden Frauen häufiger negativ unterbrochen? 
    \todo[inline]{Die Überschriften der jeweiligen Ebenen finde ich noch ein bisschen problematisch: Während man A bis C ja haben will (weibliche Repräsentation) will man doch Stereotypen (auch nicht Stereotypisierung, das ist, was Stereotypen auslösen mMn) nicht repräsentieren. Vorschlag:
    Ebene A: Repräsenation von Frauen im Parlament
    Ebene B: Beteiligung von Frauen im Parlament
    Ebene C: Berücksichtigung von Frauen in der Sprache des Parlaments
    Ebene D: Vermeidung von Stereotypisierung in den Themen
    Ebene F: Verhinderung von frauenfeindlichen Verhaltensmustern
    
    Passt das besser? Problem: Repräsentation von geschlechtsspezifischen Verhaltensmustern - Damit bauen wir doch selbst einen Stereotyp auf, nämlich, dass es solche Verhaltensmuster gibt.}
\end{itemize}

In der abschließenden !!!Diskussion/ (oder) in Kapitel ?? wird!!! ausführlich auf eine mögliche Vernetzung der einzelnen Dimensionen eingegangen, sodass diese fünf Dimensionen zunächst gesondert voneinander betrachtet und analysiert werden können. 

\todo[inline]{Ich würde das ein wenig anders schreiben. Vorschlag:
...
\todo[inline]{Hinweis: Ich finde es immer gut, wenn hier nicht gleich die nächste Teilüberschrift kommt, sondern noch ein Absatz Einleitung kommt. Vorschlag:
...
\todo[inline]{Finde hier den Begriff \emph{Arbeitsperspektive} etwas merkwürdig. Erikson, auf die wir uns hier häufig beziehen, hat die Politik als \emph{Arbeitsplatz} untersucht -- hätte das entsprechend auch eher als \enquote{Politik als Arbeitsplatz} geschrieben. Oder \enquote{Politik aus der Perspektive eines Arbeitsplatzes}.  Sollen wir das nachfolgend so schreiben?}
...
\todo[inline]{Habe einen Übergang eingebaut.}

\section{Legislative Gremien als maskuline Organisation}

Das Geschlechterregime der legislativen Gremien wird, ebenso wie andere von Männern dominierten Sektoren, häufig als \enquote{\emph{permeated by a culture of masculinity}} beschrieben \parencites[200]{erikson_2018}{lovenduski_2005}. \todo[inline]{Hier stand vorher noch, dass innerhalb dieser Insitutionen das so beschrieben wird -- ich bezweifle, dass sich die Insitutionen innerhalb so genannt haben, das wird doch eher zugeschreiben statt als selbstzuschreibung genutzt, oder? Hab das umgeschrieben.} 
...
\todo[inline]{Wenngleich ein politischer Konsens darin besteht, dass Gleichheit und Gerechtigkeit, sowie implizit Geschlechtergleichheit und ,-gerechtigkeit eine fundamentale Komponente von Demokratie darstellt, gibt es noch immer einen weltweiten Gender-Gap in den Parlamenten (ausgenommen ist hierbei..!!!)weltweit jedem Parlament (NOCH MAL PRÜFEN - ob Ruanda).  
}

\todo[inline]{Hier fehlt noch die Überleitung - hattest du geschrieben. Ich finde man kann es aber auch direkt so machen. Und es war Ruanda ;) }
...
Fehlt hier noch - Stereotypen als Theoretischer Unterbau und Unterbrechungen ...}

\todo[inline]{Vorschlag:
...
Die Stereotype würde ich dann beim Forschungsstand aufführen.}
...
Aus den Untersuchungen von \textcite{kathlene_1994} zu US-Staatsgesetzen und \textcite{back_2014} zum schwedischen Riksdag geht hervor, dass Frauen in Debatten seltener sprechen, während andere Fallstudien von \textcite{broughton_1999}, \textcite{murray_2010} und \textcite{wang_2014} zeigen, dass \enquote{women are equally active debate participants as their male colleagues} \parencites[254]{taylor-robinson_2014}[2]{back_2018}. \todo[inline]{Finde das noch ein bisschen komisch weil der Satz suggeriert, dass sich in fünf Werken das selbe Zitat findet. Vielleicht einfach besser ausschreiben: Während die Fallstudien von  \textcite{broughton_1999}, \textcite{murray_2010} und \textcite{wang_2014} dies nicht beobachten konnten. Auch bei Tyler Robinson finde ich den Satz gerade auf die Schnelle nicht und passt auch nicht zu der Erhebung von Tylor Robinson, oder?}. In Anlehnung an \textcite{back_2018} kann davon ausgegangen werden, dass es eine länderübergreifende Variation der Rolle des Geschlechts in Debatten gibt \parencite[2]{back_2018}. Eine gesonderte Untersuchung der Rolle des Geschlechts in den Debatten des Deutschen Bundestags erscheint auch aus dieser Perspektive notwendig. 
