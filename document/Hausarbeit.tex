...
Das gemeinsame Auftrete


Die Kookkurrenz von Wörtern kann in einem Dokument statistisch untersucht werden  \parencite[89]{niekler_2018}

\begin{itemize}
    \item Zwei für diese Arbeit entscheidende Problem sind aber, dass LDA voraussetzt, dass die Anzahl der Topics in einem Datensatz vorher bekannt und fix ist \parencites[93]{niekler_2018}[82f.]{blei_2012} und dass einen Verknüpfung mit Metadaten der Dokumente (Autor, Datum oder in diesem Fall besonders relevant: Geschlecht der Person) nicht möglich ist \parencite[94]{niekler_2018}. 
    \item 
\end{itemize}
