...
\begin{itemize}
    \item Ebene A: Repräsentation von Frauen im Parlament: Sind Frauen im Parlament vertreten? Wie viele Frauen sind relativ und absolut im Parlament vertreten? \todo[inline]{Wieso ist hier die Frage nach absolut und relativ gestellt? Das mach mMn hier keinen Sinn. Wenn eine Frau im Parlament vertreten ist, sind sie dann absolut vertreten? Wie kann man die Frage \enquote{Sind Frauen relativ im Paralament vertreten} beantworten? Relativ vertreten wären sie, wenn sie 50\% hätten, da die Geschlechterverteilung fast 50\% ist.!!!GG: absolut ist die anzahl bsw. 25 Frauen insgesamt, und relativ ist der prozentuale Anteil bspw. 12 Prozent - beides ist interessant, ggf. besser formulieren, hast du eine Idee?}
...
\todo{Die letzten beiden Punkte sind mir noch nicht einleuchtend! Welche anderen Faktoren unterscuchen wir? ... und wieso sind die Unterbrechungen und Rückfragen bei den KOntrollvariablen???}
...
\todo{besser: der Anteil an Reden von Frauen entspricht mit 31,0 \% annähernd dem Frauen Anteil im ..... !!!GG .... !!!! Es fehlt noch eine Tabelle die M und F mit sitzanteil und redeanteil vergleicht ... das ist wichtiger als die Fraktionen !!!!}
...
\begin{itemize}
    ...
    \item Leider kann beides nicht im Rahmen dieser Arbeit geleistet werden. 
    ...
    \todo{ich finde das Beispiel"Um an unserer Klinik als Arzt arbeiten zu können, müssen Sie die Approbation im Original vorlegen." viel zu verwirrend - ein anderes wäre besser. Zudem würde ich aus der Tabelle . Schüler mit Kindern gleichzusetzten streichen, da dies mMn nicht ganz passend und angreifbar ist ...!!!!GG)}
\end{itemize}
...
\begin{itemize}
    ...
    \item (Das nachfolgende würde ich sogar als Bulletpoints lassen, das sind dann diese Regeln) \todo{ja, ich auch! GG!!!}
...
\begin{itemize}
    \item Wie in Kapitel \ref{kapitel:gfl-studien} bereits dargelegt, nutzen Frauen GFL häufiger als Männer. Entsprechend wird auch mit Hypothese 1 (siehe Kapitel \ref{kapitel:hypothese1}) die Vermutung dargestellt, dass weibliche MPs häufiger geschlechterinklusive Begriffe und Formulierungen verwenden als Männer.
    \item Das Ergebnis des t-Test \input{} zeigt, dass die Nullhypothse $H_0$ (\emph{Frauen und Männer verwenden in ihren Reden gender-fair language gleich häufig.} zugunsten der Alternativhypothese $H_1$ (\emph{Frauen verwenden in ihren Reden häufiger gender-fair language als Männer} abgelehnt werden.
\end{itemize}
