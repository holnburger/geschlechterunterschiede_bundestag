...
Im Anschluss wird die Forschungsfrage \enquote{\emph{Inwiefern unterscheiden sich Redebeiträge und Verhalten von weiblichen und männlichen Abgeordneten im 19. Deutschen Bundestag bezüglich Häufigkeit, Thematik und Geschlechterneutralität}} umfassend untersucht. Da der 19. Deutsche Bundestag eine Vielzahl an Daten zu Reden und Verhalten der Abgeordneten zur Verfügung stellt (siehe Kapitel \ref{kapitel:datengrundlage}) und bereits in der Studie von \textcite{back_2018} thematisiert -- sowie eine weitergehende Untersuchung empfohlen wird, bietet sich dieser als Untersuchungsgegenstand an.\todo{"bietet sich an" - gefällt mir noch nicht - es sollte relevant sein....!!!}

In der abschließenden Diskussion in Kapitel \ref{kapitel:diskussion} wird ausführlich auf die einzelnen Dimensionen der Repräsentation am Beispiel des 19. Bundestages eingegangen.\todo{hier noch einige Infos zu den Ergebnissen anschließen....?!?!?!}
...
content analysis methods}) \parencite*[18]{back_2018}. Mittels solcher automatisierter Inhaltsanalysen ist es möglich, große Datensätze auszuwerten und zu Operationalisieren. Zwar ist es auch zunehmend mit qualitativen Methoden möglich, große Textmengen zu erfassen und zu bewerten \parencite[vgl.][]{raediker_2019} -- allerdings ist auch bei computergesützter Auswertungssoftware auch weiterhin die manuelle codieren von Segmenten und die Vergabe von Kategorien notwendig \parencite[52f.]{raediker_2019}. 

Bei automatisierten Inhaltsanalysen ist ein manueller Eingriff allerdings nicht mehr nötigt -- hier wird dem Rechner diese Aufgabe übertragen. wie beispielsweise das der \emph{Latent Dirichlet Allocation} \parencite[78f.]{blei_2012} ist ein manueller Eingriff und die manuelle codieren nicht nötig.  -- es handelt sich um ein probabilistisches Model, welches Themen (im Original \enquote{topics})
