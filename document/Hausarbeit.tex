...
\begin{table}
    \centering
    \caption[Die zehn häufigsten genderinklusiven Formulierungen in den Reden des Bundestages]{Die zehn häufigsten genderinklusiven Formulierungen in den Reden des Bundestages}
...
\todo[inline]{JOSEF: es fehlt noch ein Überblick wie die labels gebildet wurden...  }
...
Ergebnisse:Bezug auf Reproduktion von Stereotypen ..findet statt .. beispiele nennen und Literaturbezug herstellen ... 
...
\todo[inline]{Stichpunkte: GFL: genderdik ungenügend - bedarf weitererer interdisziplinärer Ausarbeitung ..unspezifisch oder zu spezifisch - oder domänenbezug.. von laier erstelltes dik - ohne LinguistInnen, das wäre notwendig  (crowd - JH?) ... die aussprache ist nicht protokolliert .. daher keine gender gaps auffindbar (Student_Innen nicht erkennbar) hierfür wären audiodaten oder hinweise in den protokollen notwendig, unter den 10 häufigsten finden wir kolleginnen und kollegen , damen und herrren etc. kommen nahezu in jeder rede vor (seiehe VERWEIS) und verzerrren die ganze statistik,  ,  
hasselmeier und jenny: wörterbücher immer hohe domänenabhängigkeit, daher spezifisch Politik-wörterbuch notwendig


THEMEN: am ende .. bäck 2018 - brauchen einen besseren zugang zu daten - wir haben unsere bisherige forschung frei zugänglich gemacht um weitere arbeit mit unseren daten zu ermöglichen.. - auch bäck sagte automatic analyse könnte genutzt werden, dies haben wir gemacht - was einerseits die ergebnisse vn wängerud bestätigt - welche sie hart und soft nannte - wir kommen auf ähnlich themen - ohne vorherige einteilung in hard und soft, auch themen identifizierbar welche vorher nicht einzuordnen waren/ entdeckt worden wären




FORSCHUNGSAUSBLICK: unsere daten können als ausgangspunkt verwendet werden ... diktionar wäre sinnvoll langfristig 
...
auch die Frage : WER unterbricht? das war nciht gegenstand dieser Arbeit 
