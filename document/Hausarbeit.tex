...
Die Theorie des \emph{Workplace-Approach} von \textcite{erikson_2018} und das Konzept der \enquote{\emph{culture of masculinity}} von \textcite{lovenduski_2005} sowie \textcite{erikson_2018} dargestellt bilden den Ausgangspunkt der Forschung. Eine geschlechtergerechte Repräsentation wird in dieser Arbeit weder ausschließlich daran gemessen, ob die gleiche Anzahl an Frauen und Männern im Parlament vertreten ist (A), noch anhand der politischen Ergebnisse. Eine wesentliche Vorannahme dieser Forschung ist, dass das legislative Arbeitsumfeld für sich genommen ebenso wichtig ist, wie die Möglichkeiten der weiblichen MPs die Ergebnisse zu beeinflussen \emph{\enquote{(workplace approach)}}.Sowohl die Beteiligung von weiblichen MPs an den Parlamentsdebatten (B), die Berücksichtigung von Frauen in der Sprache der Parlamentsdebatten (C) die Vermeidung von geschlechtsbezogenen Stereotypisierungen (D) als auch die Verhinderung von frauenfeindlichen Verhaltensmustern (E) zählen hierbei zu dem legislativen Arbeitsumfeld. Innerhalb des Arbeitsumfelds können informelle Praktiken und Normen der \emph{culture of masculinity} als Hindernis für die Schaffung eines geschlechtergerechten Arbeitsumfeldes fungieren \parencite[200]{erikson_2018}.
...
Eine Hypothesenprüfung war aufgrund von methodischen und technischen Bedingungen nicht möglich und es kann Aussage bezüglich der Verwendung von GFL im 19. Deutschen Bundestag getätigt werden. Es bedarf ein e, basierend auf den Plenardebatten, unter interdisziplinärer Beteilung von Wissenschaftler*innen entwickeltes Diktionär.
...
Aus unserer Untersuchung geht hervor, dass die Themen der Reden sich zwischen Männern und Frauen signifikant unterscheiden: \emph{Frauen reden häufiger zu den Themen Erziehung, Soziale Sicherung und Bildung und Männer reden häufiger zu Wirtschaft, Energie und Infrastruktur.} Um gesellschaftliche Stereotypisierungen abzubauen, ist es essentiell, dass diese im Deutschen Parlament nicht reproduziert werden. Parlamentarier*innen dienen nicht nur als wichtige Akteure in der Gesetzgebung, sondern sich auch Teilnehmende an der öffentlichen Debatte und Mitwirkende an der öffentlichen Meinungsbildung \parencite[188]{dahlerup_2018}. Wenn weiterhin vermehrt Frauen zu den Themen \emph{Erziehung, Soziale Sicherung und Bildung} sprechen, während Männer vermehrt zu den Themen \emph{Wirtschaft, Energie und Infrastruktur} sprechen -- werden die vorherrschenden Stereotypisierungen aufrechtgehalten und reproduziert.
 \todo[inline]{Da kann nochmal womens issues - doppeldeutigkeit! - genannt werden - einerseits stereotypisierungen - andererseits womans themen Wichtig  und Schwangerschaft ...}
    
    Ebene E: Verhinderung von frauenfeindlichen Verhaltensmustern

\todo[inline]{TEXT FEHLT NOCH} 


\todo[inline]{Ausgangspunkt der vorliegenden Arbeit war die Annahme, dass der 19. Deutschen Bundestag ebenfalls von einer \enquote{\emph{culture of masculinity}} geprägt ist und dies neben weiteren Faktoren die Geschlechtergerechtigkeit des Arbeitsumfeldes zum Nachteil von Frauen beeinflusst. In Bezug auf die Unterbrechungen in den Reden sowie die sprachliche Einbeziehung von Frauen - keine Unterschiede --- (WICHTIGER HINWEIS - AUSSAGE DAZU: wie viel GFL wird insgesamt genutzt - also nicht nur der Vergleich sondern auch wie viel GFL insgesamt im deutschen bundertag zu finden ist}
