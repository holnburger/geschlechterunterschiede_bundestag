...
\begin{table}[htb]
    ...
    \input{document/tables/genderinklusive_formulierungen_zufall.tex}
...
Wie umfänglich dargelegt, wird vermutet, dass weibliche MPs häufiger als ihre männlichen Kollegen Gebrauch von genderinklusiven Begriffen und Formulierungen machen (siehe Kapitel \ref{kapitel:gfl-studien} und \ref{kapitel:hypothese2}). Eine Überprüfung mittels des entwickelten Diktionärs (vgl. Kapitel \ref{kapitel:diktionär}) zeigt jedoch, dass ein signifikanter Unterschiede in der Nutzung von genderinklusiver Sprache zwischen den Geschlechtern zwar festzustellen ist, der Unterschied hierbei aber marginal ist. So zeigt das Ergebnis des t-Test (\input{document/results/t-test_apa_result.tex}), dass die Nullhypothese $H_0$ (\emph{Frauen und Männer verwenden in ihren Reden gender-fair language gleich häufig)} zugunsten der Alternativhypothese $H_1$ (\emph{Frauen verwenden in ihren Reden häufiger gender-fair language als Männer} abgelehnt werden kann. Vergleicht man aber die Mittelwerte (0,014 vs. 0,013 Anteil an GFL-Begriffen und Formulierungen in den Reden) und betrachtet den Boxplot (vgl. Abb. \ref{fig:boxplot_gfl_geschlecht}), zeigt sich ein nur unwesentlicher Unterschied in der Nutzung von GFL.
...
\input{document/tables/dunn-test.tex}
...
\begin{table}
    ...
    \input{document/tables/genderinklusive_begriffe_top.tex}
...
Abgeordnete der AfD-Fraktion werden somit häufiger als Mitglieder aller anderen Fraktionen mit Zwischenrufen, Gegenrufen, Widerspruch und auslachen unterbrochen. Eine Begründung hierfür findet sich in der Strategie der AfD im Bundestag. Durch Povokationen und Grenzüberschreitungen versuchen die Rechtspopulisten, möglichst viel Aufmerksamkeit für ihre Beiträge zu generieren \parencite[vgl.][3ff.]{ruhose_2019}\footnote{Eine Zusammenfassung der des Auftretens der AfD im Parlament findet sich bei \textcite{ruhose_2019}.}. So versucht die AfD beispielsweise auch, das parlamentarische Instrument der Zwischenfrage gezielt für Störungen der Debatte zu nutzen \parencite[5]{ruhose_2019}. Diese Störungen und Grenzüberschreitungen führen zu zahlreichen Unterbrechungen durch Empörung. 

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{document/images/boxplot_unterbrechung_fraktion.pdf}
...
\input{document/tables/dunn-test-unterbrechungen.tex}

Festzuhalten ist als, dass die Vermutung, dass Frauen eher unterbrochen werden, nicht bestätigt werden konnte und sogar das Gegenteil -- Männer werden häufiger unterbrochen als Frauen -- anzunehmen ist. Da die AfD besonders häufig unterbrochen wird und diese Fraktion hauptsächlich aus männlichen Abgeordneten besteht (vgl. Tab. \ref{table:vergleich_sitze_reden}), könnte hier eine Verzerrung durch die Veränderung der Plenardebatte seit Einzug der AfD vorliegen. Hierbei wäre es besonders interessant, auch die vorherigen Legislaturperioden bezüglich der Unterbrechungen von Redner*innen zu untersuchen.


\Chapter{Methodenkriktik und Forschungsausblick}\label{kapitel:methodenkritik}

Wie bereits in Kapitel \ref{kapitel:auswertung_gfl} beschrieben, eignet sich das in diesem Rahmen entwickelte Wörterbuch mit genderinklusiven Begriffen und Formulierungen nicht, um die Nutzung von geschlechterinklusiver Sprache in den Plenardebatten zu untersuchen. Die Begriffe sind hierfür leider zu unspezifisch (beispielsweise \enquote{alle}, \enquote{frei}) oder zu spezifisch (beispielsweise \enquote{Zauberkraft innehabende Person} als genderinklusive Variante von \enquote{Hexe}) für die Verwendung in dieser Arbeit. Die von \textcite[2626]{haselmayer_2017} angesprochene Problematik der Domänenabhängikeit zeigt sich besonders deutlich in dieser Erhebung -- da die Plenardebatten des Bundestages durch formelle und informelle Regelungen geprägt sind, welche sich von anderen Domänen stark unterscheiden, konnte das Diktionär hier nicht angewendet werden. Es müsste hierfür ein eigenes Diktionär, basierend auf den Plenardebatten, unter interdisziplinärer Beteilung von Wissenschaftler*innen entwickelt werden.
...
EBENEN AUSWERTEN - Problematisch 
ANALYSE DES ARBEITSPLATZES; 

 Unterbrechungen im plenum haben wir untersucht  

weiter forschung ist notwendig um den arbeitsplatz zu analysieren ... z.b in form von Befragungen der MPs  - um zu untersuchen ob es sich um eine gendered instistution od. maskuline Orga handelt??? 
...
\todo[inline]{Weitere Forschung: 

Eine weitere zu Untersuchende Hypothese könnte lauten: Frauen erfahren häufiger Rückfragen in ihren Reden, wenn wenige andere Frauen zu diesem Thema gesprochen haben.Diese Hypothese kann nur in Verbindung mit der Hypothese 3 zur Thematisierung in den Reden überprüft werden. Dieser Hypothese würde die Annahme zugrunde liegen, dass Frauen eher durch Rückfragen unterbrochen werden, da Ihnen in diesen Themen Inkompetenz unterstellt wird. Die vorliegende Arbeit hat mit Hinblick auf die Topics einen ersten Teil der Analyse gestellt und weitergehende Forschung ist wünschenswert.

Wer unterbricht? das war nicht gegenstand dieser Arbeit - weitere Forschung wünschenswert 


Nach \textcite{back_2018} bedarf es einem besseren Zugang zu Daten (Quelle?) -- wir haben unsere bisherige Forschung frei zugänglich gemacht um weitere Arbeit mit unseren Daten zu ermöglichen .... .Alle dieser Arbeit zugrunde liegenden Daten und die zur Auswertung und Aufbereitung entwickelten Skripte sind öffentlich zugänglich und können zur Reproduktion sowie weiterer Forschung genutzt werden. Die Daten können über die Plattform \emph{Github} eingesehen und heruntergeladen werden: \url{https://github.com/holnburger/geschlechterunterschiede_bundestag}}
...
\todo[inline]{Ausgangspunkt der vorliegenden Arbeit war die Annahme, dass der 19. Deutschen Bundestag ebenfalls von einer \enquote{\emph{culture of masculinity}} geprägt ist und dies neben weiteren Faktoren die Geschlechtergerechtigkeit des Arbeitsumfeldes zum Nachteil von Frauen beeinflusst. In Bezug auf die Unterbrechungen in den Reden sowie die sprachliche Einbeziehung von Frauen - keine Unterschiede --- (!!!! WICHTIGER HINWEIS - AUSSAGE DAZU: wie viel GFl wird insgesamt genutzt - also nicht nur der Vergleich sondern auch wie viel gfl insgesamt im deutschen bundertagzu finden ist ?!?!?}

 \todo[inline]{HIER ein Übergang zum Abschlusszitat 
Am besten so Formulieren . dass ein fließender Übergang in das Abschlusszitat möglich ist ...}
