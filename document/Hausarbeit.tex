...
\todo[inline]{Ein großer Teil der Reden kommt ohne negative Unterbrechungen (Lachen, Zuruf, Gegenruf, Widerspruch) aus (vgl. Abb. \ref{histo:reden_unterbrechung}}
...
Ohne eine vorherige Einteilung des Themen in \emph{soft} und \emph{hard Topics} konnten wir ähnliche Ergebnisse (???können wir das so schreiben!!!!) im Deutschen Bundestag erzielen wie \textcite{w???!!!welches JAHR???!} im Schwedischen \emph{Riksdag}. 
...
!!!!Einleitung für das folgende ZITAT!!!!!!
