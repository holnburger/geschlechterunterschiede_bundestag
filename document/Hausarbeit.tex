...
\section{Redeanteile in Parlamentsdebatten}
...
\todo[inline]{Hier noch Beispielgrafik und Erklärung den verschiedenen Algorithmen: FREX und Prob. Words. 
Vorgehen bei manuellem Labeling der Topics.}
...
\todo[inline]{Erklärung der Unterschiedlichen Arten von Unterbrechungen. Verweis auf Abb. \ref{fig:protokoll_bsp}.
Lachen vs. Heiterkeit. Zurufe und Widerspruch. 
Überprüfung Fraktionsvorsitz
ANOVA?}
...
\todo[inline]{Außerdem: Je länger die Rede desto eher die Möglichkeiten auf Unterbrechungen. Erwartet wird auch, dass Vorsitzende häufiger unterbrochen werden. 
Deshalb: Nicht einfach nur die Anzahl der Unterbrechungen sondern die Anzahl der Unterbrechungen im Verhältnis zur Länge der Rede in Wörtern.}
