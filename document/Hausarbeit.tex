...
\begin{itemize}
    ...
    \todo[inline]{!!!Während die ersten drei Punkte die Repräsentation von Frauen effektiv erhöht, führen die letzten beiden Punkte zu einer verringerung der Repräsenation von Frauen. Etwa dadurch, dass die Kosten für eine Beteiligung erhöht wird oder irgendwie sowas.}
\end{itemize}
...
Im Anschluss wird die Forschungsfrage \enquote{\emph{Inwiefern unterscheiden sich Redebeiträge und Verhalten von weiblichen und männlichen Abgeordneten im 19. Deutschen Bundestag bezüglich Häufigkeit, Thematik und Geschlechterneutralität}} umfassend untersucht. Da der 19. Deutsche Bundestag eine Vielzahl an Daten zu Reden und Verhalten der Abgeordneten zur Verfügung stellt (siehe Kapitel \ref{kapitel:datengrundlage}) und bereits in der Studie von \textcite{back_2018} thematisiert und eine weitergehende Untersuchung gefordert wird, erscheint dieser Untersuchungsgegenstand besonders relevant.\todo[inline]{Ist das besser? Bin mir noch unsicher}

In der abschließenden Diskussion in Kapitel \ref{kapitel:diskussion} wird ausführlich auf die einzelnen Dimensionen der Repräsentation am Beispiel des 19. Bundestages eingegangen.\todo[inline]{hier noch einige Infos zu den Ergebnissen anschließen....?!?!?! JH: Jap}


\Chapter{Theoretischer Hintergrund}

Nachfolgend wird die Theorie des \emph{Workplace-Approach} von \textcite{erikson_2018} und das Konzept der \enquote{\emph{culture of masculinity}} von \textcite{lovenduski_2005} sowie \textcite{erikson_2018} dargestellt, welche maßgeblich für den Hintergrund und die weitere Argumentation dieser Arbeit dienen. 
...
Eine weitere \emph{negative} Unterbrechung der Render*innen können Rückfragen darstellen - allerdings ist hier eine eindeutige negative Intention nicht anzunehmen. Entsprechend sollen Rückfragen gesondert untersucht werden. Auf Basis der Arbeiten von \textcite{brescoll_2011} und \textcite{eagly_2002} wird erwartet, dass Frauen bei Themen, welche stereotypisch eher nicht mit Frauen verbunden werden, häufiger Inkompetenz unterstellt wird als männliche MPs. Dies kann sich in der Anzahl an Rückfragen äußern, welche während einer Rede gestellt werden. \todo[inline]{fehlt hier noch eine Hypothese?????? letzter Absatz wirkt ansonsten etwas verloren}
\todo[inline]{das war die hypothese mit den Rückfragen, die haben wir jetzt ja rausgenommen. Sonst würde ich einfach diesen Absatz noch rausnehmen oder halb kürzen, dass Unterbrechungen nicht die einzige Art der negativen Verhaltens gegenüber Frauen sein muss.}
...
\todo[inline]{Fußnote formatieren ohne Lücke, JH: Geht nicht, ist eine URL.}
...
Auch in dieser Arbeit werden diese weiterentwickelten Methoden genutzt, um die in Kapitel \ref{kapitel:ueberblick_reden} bereits angedeuteten umfassenden Datenmengen \todo[inline]{Datenmengen nochmal nennen. JH: Wie meinst du das?} erfassbar und auswertbar zu machen.
...
\todo[inline]{Kritik an dem entwickelten Diktionär bezüglich der geschickt-gendern --> teilweise findet zu viel (einbauen der 10 häufigsten und der 10 wenigsten) genderinklusiven wörter. --> Kritik Domänenabhängikeit: geschickt-gendern hier ein unpassendes Wörterbuch für die Untersuchung politischer reden. Im weiteren Verlauf untersuchen wir deshalb nur noch die Formulierungen. Kolleginnen und Kollegen nehmen wir mal raus und gucken uns das an.}
