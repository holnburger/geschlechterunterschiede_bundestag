...
Die vermutete Annahme, dass Fraktionsvorsitzende im Mittel häufiger unterbrochen werden, kann h
...
Nach \textcite{back_2018} bedarf es einem besseren Zugang zu Daten (Quelle?) -- wir haben unsere bisherige Forschung frei zugänglich gemacht um weitere Arbeit mit unseren Daten zu ermöglichen .... .Alle dieser Arbeit zugrunde liegenden Daten und die zur Auswertung und Aufbereitung entwickelten Skripte sind öffentlich zugänglich und können zur Reproduktion sowie weiterer Forschung genutzt werden.\footnote{Die Daten können über die Plattform \emph{Github} eingesehen und heruntergeladen werden: \url{https://github.com/holnburger/geschlechterunterschiede_bundestag}}}
