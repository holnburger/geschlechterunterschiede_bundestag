...
\begin{itemize}
    ...
    \todo[inline]{!!!Während die ersten drei Punkte die Repräsentation von Frauen effektiv erhöht, führen die letzten beiden Punkte zu einer verringerung der Repräsenation von Frauen. Etwa dadurch, dass die Kosten für eine Beteiligung erhöht wird oder irgendwie sowas. !!!!!!!GINA NEU Vorschlag: Der anfängliche Versuch alle 5 Ebenen mit einem \emph{Repräsentationsbegriff} zu erfassen (A: Repräsentation von Frauen im Parlament, B:Repräsentation von Frauen in Parlamentsdebatten, C: Repräsentation von Frauen \emph{in} Parlamentsdebatten scheitert an der Ebene D und E. Bei diesen beiden Ebenen geht es vielmehr um eine Reproduktion (D: die Reproduktion von Stereotypen, F: die Reproduktion von frauenfeindlichen Verhaltensmustern).}
\end{itemize}
...
Im Anschluss wird die Forschungsfrage \enquote{\emph{Inwiefern unterscheiden sich Redebeiträge und Verhalten von weiblichen und männlichen Abgeordneten im 19. Deutschen Bundestag bezüglich Häufigkeit, Thematik und Geschlechterneutralität}} umfassend untersucht.\todo[inline]{GINA NEU VORSCHLAG: Während eine Vielzahl an Studien (Q!!!) den Schwedischen Riksdag fokussiert, ist der Deutsche Bundestag in Hinblick auf genderbezogene Partizipationsunterschiede bis dato weniger erforscht und daher Gegenstand dieser Untersuchung(Q!!!).}

In der abschließenden Diskussion in Kapitel \ref{kapitel:diskussion} wird ausführlich auf die einzelnen Dimensionen der Repräsentation am Beispiel des 19. Bundestages eingegangen.\todo[inline]{hier noch einige Infos zu den Ergebnissen anschließen....?!?!?! JH: Jap Gina: und dieser Absatz ist noch sehr seltsam... }
...
\todo[inline]{Problematisch: Exakt den selben Absatz haben wir schon wieter oben aufgeführt -- entsprechend können wir in hier nicht einfach noch mal nutzen. Der muss raus und anders eingeleitet werden. Hier muss mehr über die Studien geredet werden, Menegatti ist mehr Theorie. GG NEU!!!: BESSER SO?}
...
\todo[inline]{NEU noch zu überarbeiten und optimale Stelle hierfür finden!!!!In einer Studie mit deutschen und belgischen Schulkindern wurde festgestellt, dass die grammatikalische Form der Berufsbezeichnungen die Wahrnehmung der Kinder von typisch männlichen Berufen beeinflusst: wenn Berufe im Männlichen dargestellt wurden (z.B, Ingenieure) wurden weiblichen Ingenieurinnen mental weniger angesprochen als wenn feminine und maskuline Wortpaare genutzt wurden (z.B. Ingenieurinnen und Ingenieure oder weibliche und männliche Ingenieure \parencite {vervecken_2013}{sczency_2016}…). 
In another study, adult speakers as well envisaged more men in an occupation when job advertisements included more masculine than feminine forms ( siehe \parencite {gaucheretal_2011} [3]{scency_2016} … scency!!!!).(?????) In Anlenung an sczency!!! Können im Allgemeinen verschiedene Strategien verwendet werden, um sprachliche Geschlechtergerechtigkeit zu erreichen und schädliche Auswirkungen von männlichen Generika zu vermeiden: Neutralisierung, Feminisierung und Kombination der beiden. Die richtige Strategie ist hierbei abhängig vom Typ der betreffenden Sprache (grammatikalische Geschlechtssprache, natürliche Geschlechtssprache, oder geschlechtslose Sprache \parencite [][Vgl.] {bußmann_2003} alles in [3]{scency_2016}.}
...
JH: Wir haben hierzu ja gar keine Hypothesen, wir untersuchen hier ja nur rein deskriptiv das Verhältnis von Sitzen und Reden durch Frauen. Eine Kontrollvariable können wir hier auch nicht einbauen, eben da wir nichts testen. Die Kontrollvariablen untersuchen ja z. B. die Unterbrechungen auf Drittvariablen wie \enquote{ist die Person auch Fraktionsvorsitzende}. EIch wüsste nicht, wie eine Kontrollvariable da eingebaut werden sollte. Der deskriptive Erkenntnisgewinn liegt hier bei: Intertessant, dass bei den Grünen sogar ein noch höherer Anteil an Reden von Frauen kommt, obwohl sie den höchsten Anteil an Frauen im Parlament haben. Da gibt's ja keine Drittvariablen zu testen.}

\section{Kontrollvariablen}

Natürlich wird die Anzahl an Unterbrechungen und die Nutzung genderinklusiver Sprache von mehr Faktoren als nur dem Geschlecht beeinflusst -- linke Parteien nutzen vermutlich häufiger genderinklusive Sprache als rechte Parteien, Fraktionsvorsitzende werden vermutlich häufiger unterbrochen als MPs, welche nicht den (stellvertretenden) Fraktionsvorsitz stellen.
...
\todo[inline]{ÜBERSICHT DER HYPOTHESEN NOCHMAL}
...
Mit diesen Regeln konnten zunächst 507 Formulierungen identifiziert werden, welche nach einer manueller Bereinigung auf 417 genderinklusive Formulierungen gekürzt wurden.\footnote{Hierbei wurden zum einen Formulierungen, die durch diese Regelungen nicht gefunden werden können, etwa \enquote{Männer und Frauen}, manuell ergänzt und Formulierungen, welche nicht inklusiv sind aber diesen Regeln entsprechen, entfernt. So fand sich beispielsweise auch vier Mal die Kombination \enquote{Hitler und Stalin} -- welche die formulierten Regeln erfüllt.} Die zehn häufigsten Ansprachen, welche diesen Regeln entsprechen, sind in Tabelle \ref{table:top_gender_phrasen} aufgeführt. 
...
Mittels der Protokolle des 19. Deutschen Bundestages und STM ist es möglich, sowohl Häufigkeit als auch Inhalt der Themen der Parlamentsdebatten zu bestimmen als auch Unterschiede in den Thematisierungen nach Geschlecht der Abgeordneten festzustellen. Anders als \textcite{back_2014} kann somit ohne Vorannahmen bezüglich der Themenwahl von männlichen und weiblichen Abgeordneten vorgegangen werden und eine vorherige Unterteilung in \emph{soft} und \emph{hard policies}, welche geschlechtsspezifisch favorisiert würden, muss nicht vorgeommen werden. Mittels dieser Methode ist es möglich, auch Themen zu entdecken, welche vorher noch nicht als geschlechterspezifisch identifiziert wurden und somit möglicherweise für neue Erkenntnisse förderlich.

Um die Hypothese 2 (siehe Kapitel \ref{kapitel:hypothese2} zur Thematisierung von Reden nach Geschlecht zu untersuchen, werden zunächst die Anzahl der Themen und die mit diesem Themen verbundenen Wörter bestimmt. Anschließend werden die Topics mit einem oder mehreren Schlagwörtern versehen (\emph{Label}), oder, wenn kein sinnvolles Label aufgrund unzusammenhängendem Vokabular in einem Topic vergeben werden kann, aus der Erhebung entfernt. Abschließend ist es eine Untersuchung bezüglich der Thematisierung nach Geschlecht der Abgeordneten möglich -- hierbei wird untersucht, ob ein signifikanter Unterschied zwischen den Gruppen zu beobachten ist \parencite[vgl.][3]{roberts_2013}.  

\subsection{Erfassung von Unterbrechungen}

Da der Stenografische Dienst des Bundestages nicht nur den Wortlaut der Reden sondern auch Unterbrechungen, Zustimmung, Rückfragen und auch sonstige Zwischenfälle dokumentiert, es es möglich, auch  
...
\begin{figure}
    ...
    \caption[Thematisierungen in den Bundestagsreden mit den höchsten Unterschieden zwischen den Geschlechtern]{Thematisierungen in den Bundestagsreden mit den höchsten Unterschieden zwischen den Geschlechtern. Auswertung der Themen mit \emph{stm topic models}. Reihenfolge durch \emph{stm}. Quelle: Eigene Erhebung}
...
\todo[inline]{Eine Seite eines Protokolls als Beispiel in den Anhang packen.}
...
\begin{figure}[H]
    \centering
    \includegraphics[page=7,scale=0.7]{images/protokoll_beispiel.pdf}
