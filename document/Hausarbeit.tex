...
Der anfängliche Versuch alle 5 Ebenen mit einem \emph{Repräsentationsbegriff} zu erfassen (A: Repräsentation von Frauen im Parlament, B: Repräsentation von Frauen in Parlamentsdebatten, C: Repräsentation von Frauen \emph{in} Parlamentsdebatten) scheitert an den Ebenen D und E. Bei diesen beiden Ebenen geht es darum eine Reproduktion zu vermeiden (D: die Reproduktion von Stereotypisierungen, F: die Reproduktion von frauenfeindlichen Verhaltensmustern). \todo[inline]{Der letzte Satz macht jetzt für mich noch keinen Sinn. "Es geht um eine Reproduktion". Ich hatte das jetzt anders verstanden -- während die ersten drei Versuchen, etwas zu verbessern (höhere Repräsenation) sind die letzten beiden auf Vermeidung ausgerichtet (keine frauenfeindlicchen Verhaltensmuster)GGNEU: so besser?.}
...
Im Anschluss wird die Forschungsfrage \enquote{\emph{Inwiefern unterscheiden sich Redebeiträge und Verhalten von weiblichen und männlichen Abgeordneten im 19. Deutschen Bundestag bezüglich Häufigkeit, Thematik und Geschlechterneutralität}} umfassend untersucht. Der Deutsche Bundestag ist in Hinblick auf geschlechtsbezogene Repräsentationsunterschiede in den Parlamentsdebatten bis dato weniger bis gar nicht erforscht und daher Gegenstand dieser Untersuchung.
\todo[inline]{irgendwie gefallen mir die beiden letzten Absätze noch nicht so wirklich. Der vorletzte Absatz wirkt irgendwie gedoppelt.}
...
\todo[inline]{Das Zitat ggf. in den unteren Absatz einpflegen? Dann ist es mehr einbezogen?! Wäng.- bezug ist erst im letzten Satz des folgeabschnitts}
...
\todo[inline]{Die folgende Abbildung wird mit abgeschnittener Überschrift angezeigt}
...
Abgeordnete der AfD-Fraktion werden somit häufiger als Mitglieder aller anderen Fraktionen mit Zwischenrufen, Gegenrufen, Widerspruch und Auslachen unterbrochen. Eine Begründung hierfür findet sich in der Strategie der AfD im Bundestag. Durch Provokationen und Grenzüberschreitungen versuchen die Rechtspopulisten, möglichst viel Aufmerksamkeit für ihre Beiträge zu generieren \parencite[vgl.][3ff.]{ruhose_2019}\footnote{Eine Zusammenfassung der des Auftretens der AfD im Parlament findet sich bei \textcite{ruhose_2019}.}. So versucht die AfD beispielsweise auch, das parlamentarische Instrument der Zwischenfrage gezielt für Störungen der Debatte zu nutzen \parencite[5]{ruhose_2019}. Diese Störungen und Grenzüberschreitungen führen zu zahlreichen Unterbrechungen durch Empörung. 
...
Die Vermutung, dass Frauen eher unterbrochen werden, kann nicht bestätigt werden und sogar das Gegenteil -- Männer werden häufiger unterbrochen als Frauen -- ist gegeben. Da die AfD besonders häufig unterbrochen wird und diese Fraktion hauptsächlich aus männlichen Abgeordneten besteht (vgl. Tab. \ref{table:vergleich_sitze_reden}), könnte hier eine Verzerrung durch die Veränderung der Plenardebatten seit Einzug der AfD vorliegen. Eine Untersuchung der Plenardebatten vor dem 19. Deutschen Bundestag und die Veränderung der Debattenkultur durch die AfD könnte für die zukünftige Arbeiten hierbei besonders interessant sein.
...
Eine solche Analyse ermöglicht eine viel tiefgreifendere Analyse möglicher Diskriminierungen von Frauen am Arbeitsplatz Parlament. Eine Untersuchung der Unterbrechung von Frauen in den Plenardebatten bedient deshalb nur einen kleinen Teil der Untersuchung möglicher Diskriminierung. Außerdem handelt es sich bei den Debatten im Plenum nur um eines von vielen Arbeitsfeldern von MPs. Zu vielen weiteren Arbeitsfeldern sind Daten entweder nicht öffentlich oder auch gar nicht verfügbar -- etwa Fraktionssitzungen, Entscheidungen der Parteivorsitzenden, die Arbeit in vielen Ausschüssen oder die kollegiale Behandlung im Arbeitsumfeld. Auch wenn quantitative Auswertungen mit großen Datensätzen und automatisierten Elementen eine Vielzahl von Untersuchungen zulässt -- qualitative Untersuchungen und Befragungen könnten bei diesem Untersuchungsgegenstand möglicherweise validere Ergebnisse zu Formen der Diskriminierung von Frauen in der Politik hervorbringen. 
...
Die Forderungen einer deskriptiven parlamentarischen Geschlechtergleichheit haben ebenso wie die Forderungen nach substantieller Geschlechtergleichheit bereits ihre Wege in die wissenschaftliche Diskussion und in die Politik gefunden. Einer geschlechtergerechten Sprache sowie dem geschlechtsbezogenen Verhalten im Parlament wurde bisher allerdings weniger Aufmerksamkeit gewidmet.
Um geschlechtsbezogene Repräsentationsunterschiede auf allen fünf Ebenen zu analysieren, wird die Frage \emph{\enquote{Inwiefern unterscheiden sich Redebeiträge und Verhalten von weiblichen und männlichen Abgeordneten im 19. Deutschen Bundestag bezüglich Häufigkeit, Thematik und Geschlechterneutralität}} wurden anhand dreier übergeordneter Hypothesen untersucht:
...
Des weiteren wurden auch die Anzahl der Reden von Frauen sowohl im gesamten Parlament als auch nach Fraktionen untersucht. 

Ebene A: Repräsentation von Frauen im Parlament

Insgesamt sind in dem 19. deutschen Bundestag ( ZAHL ) weibliche MPs vertreten, d.h. mit Blick auf die deskriptive Repräsentation von Frauen ist eine Gleichstellung der Geschlechter bisher nicht erreicht wurden -- und hat sich im Vergleich zu dem letzten Jahr sogar verschlechtert. 

Ebene B: Beteiligung von weiblichen MPs an den Parlamentsdebatten

In dem 19. Deutschen Bundestag (Auswerttungszeitraum ...!!!) haben männliche MPs \emph{5719 Reden} gehalten, während es bei den weiblichen MPs lediglich \emph{2575 Reden} waren. Während die absoluten Zahlen zeigen, dass Frauen weniger Reden im Parlament halten, liegt der relative Anteil an Reden von weiblichen MPs mit 31,0 Prozent nur marginal unter dem Frauenanteil im Bundestag mit 31,8 Prozent. Demnach nehmen Frauen \emph{in Relation zu ihren Sitzanteilen} gleich viel an den Parlamentsdebatten teil wie männliche MPs.

Ebene C: Berücksichtigung von Frauen in der Sprache der Parlamentsdebatten

Eine Hypothesenprüfung war aufgrund von methodischen und technischen Bedingungen nicht möglich und es kann Aussage bezüglich der Verwendung von GFL im 19. Deutschen Bundestag getätigt werden. Es bedarf ein ausführliches, domänenabhängiges, basierend auf den Plenardebatten und unter interdisziplinärer Beteilung von Wissenschaftler*innen entwickeltes Diktionär.
    
Ebene D: Vermeidung von geschlechtsbezogenen Stereotypisierungen

Aus unserer Untersuchung geht hervor, dass die Themen der Reden sich zwischen Männern und Frauen signifikant unterscheiden: \emph{Frauen reden häufiger zu den Themen Erziehung, Soziale Sicherung und Bildung und Männer reden häufiger zu Wirtschaft, Energie und Infrastruktur.} Um gesellschaftliche Stereotypisierungen abzubauen, ist es essentiell, dass diese im Deutschen Parlament nicht reproduziert werden. Parlamentarier*innen dienen nicht nur als wichtige Akteure in der Gesetzgebung, sondern sind ebenfalls Teilnehmende an der öffentlichen Debatte und Mitwirkende an der öffentlichen Meinungsbildung \parencite[188]{dahlerup_2018}. Wenn weiterhin vermehrt Frauen zu den Themen \emph{Erziehung, Soziale Sicherung und Bildung} sprechen, während Männer vermehrt \emph{Wirtschaft, Energie und Infrastruktur} thematisieren -- werden die vorherrschenden Stereotypisierungen aufrechterhalten und reproduziert.
Dies ist nicht zu verwechseln mit spezifischen Bedürfnisse, Interessen und Bedenken, die sich aus der Erfahrung der Frauen ergeben und vor allem von Frauen thematisiert werden \emph({politics of presence}). Beispielhaft zu nennen ist hier das Thema Schwangerschaftsabbruch (vgl. Abb. \ref{fig:differences_stm_top}).
    
    Ebene E: Verhinderung von frauenfeindlichen Verhaltensmustern

Männliche MPs werden im 19. Deutschen Bundestag signifikant häufiger unterbrochen als weibliche MPs.  ... TEXT .... 


 \todo[inline]{HIER -- Übergang zum Abschlusszitat}
...
Sicherung Fazitaussagen


(WICHTIGER HINWEIS - AUSSAGE DAZU: wie viel GFL wird insgesamt genutzt - also nicht nur der Vergleich sondern auch wie viel GFL insgesamt im deutschen bundertag zu finden ist - wäre wünschenswert in weiterer Forschung)

Die Nutzung von GFL kann die (sprachliche) Benachteiligung von Frauen systematisch senken und Vorurteile bezüglich der Geschlechter reduzieren. Gleichzeitig kann dabei eine Reproduktion von Stereotypisierungen vermieden werden. In Anlehnung an \textcite{wangnerud_2000} gehen wir davon aus, dass weibliche Politikerinnen die Interessen von Frauen in größerem Umfang als ihre männlichen Kollegen vertreten \parencite[69f.]{wangnerud_2000} und dementsprechend häufiger geschlechterinklusive Sprache verwenden. Eine Überprüfung mittels des entwickelten Diktionärs (vgl. Kapitel \ref{kapitel:diktionär}) zeigt, dass ein signifikanter Unterschiede in der Nutzung von genderinklusiver Sprache zwischen den Geschlechtern zwar festzustellen ist, der Unterschied hierbei aber marginal ist. Die Ergebnisse dieser Erhebung müssen jedoch kritisch betrachtet werden da das entwicklete Diktionär eine Vielzahl an Schwachstellen aufzuweisen hat und sich an ungenügend herausstellt (siehe Kapitel?). Die Hypothese \emph{Weibliche MPs verwenden in ihren Reden häufiger GFL als männliche MPs} kann unter diesen Umständen nicht geprüft werden.
...
Aus dieser Analyse des 19. Deutschen Bundestags geht hervor, dass die Themen der Reden sich zwischen Männern und Frauen signifikant unterscheiden: \emph{Frauen reden häufiger zu den Themen Erziehung, Soziale Sicherung und Bildung} und \emph{Männer reden häufiger zu den Themen Wirtschaft, Energie und Infrastruktur.} 

Die Hypothese, dass weibliche MPs in ihren Reden häufiger negativ unterbrochen werden (H3) konnte in dieser Arbeit nicht bestätigt werden: \emph{Weibliche MPs werden in ihren Reden im Deutschen Bundestag nicht häufiger unterbrochen als ihre männlichen Kollegen.}. Es konnte hingegen festgestellt werden, dass \emph{Männer signifikant häufiger unterbrochen werden als Frauen}.

Insgesamt wurden 8.294 Reden im 19. Deutschen Bundestag bis zum 12. April 2019 von Abgeordneten gehalten. Der Anteil an Reden von weiblichen MPs entspricht mit 31,0\% (vgl. Tabelle \ref{table:uebersicht_reden}) annähernd dem Frauenanteil im Bundestag von 31,8\% (222 Frauen)\footnote{siehe \url{https://www.bundestag.de/abgeordnete/biografien/mdb_zahlen_19/frauen_maenner-529508}}. Dementsprechend halten \emph{weibliche MPs absolut weniger Reden als ihre männlichen Kollegen}, relativ zu der Anzahl an Frauen im Parlament unterscheidet sich die Anzahl von Reden zwischen weiblichen und männlichen MPs hingegen kaum: \emph{Es gibt keinen signifikanten Unterschied in der relativen Anzahl an Reden von weiblichen und männlichen MPs.} 

Diese Forschungsarbeit kann demnach unerwartete neue Erkenntnisse in Hinblick auf geschlechtsbezogenen Repräsentationsunterschiede im 19. Deutschen Bundestag erzielen:
