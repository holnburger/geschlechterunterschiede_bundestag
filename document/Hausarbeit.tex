...
Bei genauerer Betrachtung zeigt sich, dass das entwickelte Diktionär auf Basis der Arbeit von \url{geschicktgendern.de} für diese Arbeit leider unzureichend ist. Der am häufigsten genutzte, genderinklusive Begriff lautet \enquote{alle}  -- dieser findet sich im geschicktgendern-Wörterbuch als genderinklusive Variante für den Begriff \enquote{jeder}. In den Reden findet sich der Begriff \enquote{alle} 22.231 mal wieder (vgl. Tab. \ref{table:top_gender_begriffe}). Der zweithäufigste Begriff 
...
\begin{itemize}
    \item \emph{H1 : Weibliche MPs verwenden in ihren Reden häufiger GFL als männliche MPs}
    \end{itemize}
...
Zu H1: 
    ...
    \begin{itemize}
    \item \emph{H2 : Es sind unterschiedliche Thematisierungen in den Reden der Abgeordneten feststellbar}
    \end{itemize}
    
Zu H2:     
    
    \begin{itemize}
    \item \emph{H3 : Frauen werden häufiger als Männer während einer Rede negativ Unterbrochen}
\end{itemize}
